...
//-- 供货商列表
        ...
        if ($_REQUEST['act'] == 'list') {
            ...
            $this->smarty->assign('action_link', array('href' => 'suppliers.php?act=add', 'text' => $GLOBALS['_LANG']['add_suppliers']));
            ...
            $this->smarty->display('suppliers_list.htm');
        }
...
//-- 排序、分页、查询
        ...
        if ($_REQUEST['act'] == 'query') {
            ...
            make_json_result($this->smarty->fetch('suppliers_list.htm'), '',
...
//-- 添加、编辑供货商
        ...
        if (in_array($_REQUEST['act'], array('add', 'edit'))) {
            ...
            if ($_REQUEST['act'] == 'add') {
                ...
                $this->smarty->assign('action_link', array('href' => 'suppliers.php?act=list', 'text' => $GLOBALS['_LANG']['suppliers_list']));

                $this->smarty->assign('form_action', 'insert');
                $this->smarty->assign('suppliers', $suppliers);


                $this->smarty->display('suppliers_info.htm');
            }
