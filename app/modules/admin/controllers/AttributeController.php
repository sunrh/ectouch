...
//-- 属性列表
        ...
        if ($_REQUEST['act'] == 'list') {
            ...
            $this->smarty->assign('action_link', array('href' => 'attribute.php?act=add&goods_type=' . $goods_type, 'text' => $GLOBALS['_LANG']['10_attribute_add']));
            ...
            $this->smarty->display('attribute_list.htm');
        }
...
//-- 排序、翻页
        ...
        if ($_REQUEST['act'] == 'query') {
            ...
            make_json_result($this->smarty->fetch('attribute_list.htm'), '',
...
//-- 添加/编辑属性
        ...
        if ($_REQUEST['act'] == 'add' || $_REQUEST['act'] == 'edit') {
            ...
            if ($is_add) {
                ...
                $sql = "SELECT * FROM " . $this->ecs->table('attribute') . " WHERE attr_id = '$_REQUEST[attr_id]'";
            ...
            $this->smarty->display('attribute_info.htm');
        }
...
//-- 插入/更新属性
        ...
        if ($_REQUEST['act'] == 'insert' || $_REQUEST['act'] == 'update') {
            ...
            if ($is_insert) {
                ...
                $this->db->autoExecute($this->ecs->table('attribute'), $attr, 'UPDATE', "attr_id = '$_POST[attr_id]'");
...
//-- 删除属性(一个或多个)
        ...
        if ($_REQUEST['act'] == 'batch') {
            ...
            if (isset($_POST['checkboxes'])) {
                ...
                $sql = "DELETE FROM " . $this->ecs->table('attribute') . " WHERE attr_id " . db_create_in($ids);
                $this->db->query($sql);
...
//-- 删除商品属性
        ...
        if ($_REQUEST['act'] == 'remove') {
            ...
            $this->db->query("DELETE FROM " . $this->ecs->table('attribute') . " WHERE attr_id='$id'");
            $this->db->query("DELETE FROM " . $this->ecs->table('goods_attr') . " WHERE attr_id='$id'");
...
//-- 获取某属性商品数量
        ...
        if ($_REQUEST['act'] == 'get_attr_num') {
            ...
            $sql = "SELECT COUNT(*) " .
                " FROM " . $this->ecs->table('goods_attr') . " AS a, " .
