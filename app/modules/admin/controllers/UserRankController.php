...
//-- 会员等级列表
        ...
        if ($_REQUEST['act'] == 'list') {
            ...
            $this->smarty->assign('action_link', array('text' => $GLOBALS['_LANG']['add_user_rank'], 'href' => 'user_rank.php?act=add'));
...
//-- 添加会员等级
        ...
        if ($_REQUEST['act'] == 'add') {
            ...
            $this->smarty->assign('action_link', array('text' => $GLOBALS['_LANG']['05_user_rank_list'], 'href' => 'user_rank.php?act=list'));
            $this->smarty->assign('ur_here', $GLOBALS['_LANG']['add_user_rank']);
