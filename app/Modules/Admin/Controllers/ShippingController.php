...
class ShippingController extends Controller
{
    public function actionIndex()
    {
        ...
        if ($_REQUEST['act'] == 'list') {
            ...
            $this->smarty->display('shipping_list.htm');
        }
...
//-- 模板Flash编辑器
        ...
        if ($_REQUEST['act'] == 'print_index') {
            ...
            $this->smarty->display('print_index.htm');
        }
...
//-- 编辑打印模板
        ...
        if ($_REQUEST['act'] == 'edit_print_template') {
            ...
            $this->smarty->assign('action_link', array('text' => $GLOBALS['_LANG']['03_shipping_list'], 'href' => 'shipping.php?act=list'));
            $this->smarty->assign('shipping_id', $shipping_id);


            $this->smarty->display('shipping_template.htm');
        }
