...
//-- 友情链接列表页面
        ...
        if ($_REQUEST['act'] == 'list') {
            ...
            $this->smarty->assign('action_link', array('text' => $GLOBALS['_LANG']['add_link'], 'href' => 'friend_link.php?act=add'));
            ...
            $this->smarty->display('link_list.htm');
        }
...
//-- 排序、分页、查询
        ...
        if ($_REQUEST['act'] == 'query') {
            ...
            make_json_result($this->smarty->fetch('link_list.htm'), '',
...
//-- 添加新链接页面
        ...
        if ($_REQUEST['act'] == 'add') {
            ...
            $this->smarty->assign('action_link', array('href' => 'friend_link.php?act=list', 'text' => $GLOBALS['_LANG']['list_link']));
            $this->smarty->assign('action', 'add');
            $this->smarty->assign('form_act', 'insert');


            $this->smarty->display('link_info.htm');
        }
...
//-- 友情链接编辑页面
        ...
        if ($_REQUEST['act'] == 'edit') {
            ...
            $this->smarty->assign('action_link', array('href' => 'friend_link.php?act=list&' . list_link_postfix(), 'text' => $GLOBALS['_LANG']['list_link']));
