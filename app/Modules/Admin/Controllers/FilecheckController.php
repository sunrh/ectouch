...
class FilecheckController extends Controller
{
    public function actionIndex()
    {
        ...
        if ($step == 1 || $step == 2) {
            ...
            if ($step == 1) {
                $this->smarty->assign('ur_here', $GLOBALS['_LANG']['file_check']);
            }
            if ($step == 2) {
                $this->smarty->assign('ur_here', $GLOBALS['_LANG']['fileperms_verify']);
            }

            $this->smarty->display('filecheck.htm');
        } elseif ($step == 3) {
            @set_time_limit(0);
            ...
            */
            ...
            $this->smarty->assign('dirlog', $dirlog);
            $this->smarty->assign('filelist', $filelist);
            $this->smarty->assign('step', $step);
            $this->smarty->assign('ur_here', $GLOBALS['_LANG']['filecheck_completed']);
            $this->smarty->assign('action_link', array('text' => $GLOBALS['_LANG']['filecheck_return'], 'href' => 'filecheck.php?step=1'));
