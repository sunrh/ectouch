...
//-- 活动列表页
        ...
        if ($_REQUEST['act'] == 'list') {
            ...
            $this->smarty->assign('action_link', array('href' => 'auction.php?act=add', 'text' => $GLOBALS['_LANG']['add_auction']));
            ...
            $this->smarty->display('auction_list.htm');
        }
...
//-- 分页、排序、查询
        ...
        if ($_REQUEST['act'] == 'query') {
            ...
            make_json_result($this->smarty->fetch('auction_list.htm'), '',
...
//-- 查看出价记录
        ...
        if ($_REQUEST['act'] == 'view_log') {
            ...
            $this->smarty->assign('action_link', array('href' => 'auction.php?act=list&' . list_link_postfix(), 'text' => $GLOBALS['_LANG']['auction_list']));

            $this->smarty->display('auction_log.htm');
        }
...
//-- 添加、编辑
        ...
        if ($_REQUEST['act'] == 'add' || $_REQUEST['act'] == 'edit') {
            ...
            if ($is_add) {
                ...
                $this->smarty->assign('bid_user_count', sprintf($GLOBALS['_LANG']['bid_user_count'], $auction['bid_user_count']));
            }
            ...
            $this->smarty->display('auction_info.htm');
        }
...
//-- 添加、编辑后提交
        ...
        if ($_REQUEST['act'] == 'insert' || $_REQUEST['act'] == 'update') {
            ...
            if ($is_add) {
                ...
                $auction['act_id'] = $this->db->insert_id();
            } else {
