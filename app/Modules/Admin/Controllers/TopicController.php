...
//-- 专题列表页面
        ...
        if ($_REQUEST['act'] == 'list') {
            ...
            $this->smarty->assign('action_link', array('text' => $GLOBALS['_LANG']['topic_add'], 'href' => 'topic.php?act=add'));
            $this->smarty->display('topic_list.htm');
        }
        /* 添加,编辑 */
        if ($_REQUEST['act'] == 'add' || $_REQUEST['act'] == 'edit') {
            ...
            $this->smarty->display('topic_edit.htm');
        }
        ...
        if ($_REQUEST['act'] == 'get_goods_list') {
            ...
            $tpl = 'topic_list.htm';
            make_json_result($this->smarty->fetch($tpl), '', array('filter' => $topic_list['filter'], 'page_count' => $topic_list['page_count']));
        }
    }
