...
class EmailListController extends Controller
{
    public function actionIndex()
    {
        ...
        if ($_REQUEST['act'] == 'list') {
            ...
            $this->smarty->display('email_list.htm');
        }
        ...
        if ($_REQUEST['act'] == 'query') {
            ...
            make_json_result($this->smarty->fetch('email_list.htm'), '',
...
//-- 批量删除
        ...
        if ($_REQUEST['act'] == 'batch_remove') {
            ...
            sys_msg(sprintf($GLOBALS['_LANG']['batch_remove_succeed'], $this->db->affected_rows()), 0, $lnk);
        }
...
//-- 批量恢复
        ...
        if ($_REQUEST['act'] == 'batch_unremove') {
            ...
            $lnk[] = array('text' => $GLOBALS['_LANG']['back_list'], 'href' => 'email_list.php?act=list');
            sys_msg(sprintf($GLOBALS['_LANG']['batch_unremove_succeed'], $this->db->affected_rows()), 0, $lnk);
        }
...
//-- 批量退订
        ...
        if ($_REQUEST['act'] == 'batch_exit') {
            ...
            $lnk[] = array('text' => $GLOBALS['_LANG']['back_list'], 'href' => 'email_list.php?act=list');
            sys_msg(sprintf($GLOBALS['_LANG']['batch_exit_succeed'], $this->db->affected_rows()), 0, $lnk);
        }
    }
