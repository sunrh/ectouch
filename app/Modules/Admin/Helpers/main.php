...
{
    return (preg_match('/,*' . $authz . ',*/', session('action_list')) || session('action_list') == 'all');
}
...
{
    return empty($var) ? '<img src="'. __TPL__ .'/images/no.gif" border="0" />' : '<img src="'. __TPL__ .'/images/yes.gif" border="0" />';
}
