...
class Sms
{
    ...
    */
    ...
    {
        $sql = 'SELECT `email` FROM ' . $this->ecs->table('admin_user') . " WHERE `user_id` = '" . session('admin_id') . "'";
    ...
    public function getTime()
    {
        ...
        $Tsend_str['certi_ac'] = $this->make_shop_ac($Tsend_str, 'SMS_TIME');
    ...
    //加密算法
    public function make_shop_ac($temp_arr, $token)
    {
        ksort($temp_arr);
        $str = '';
