    ...
    public function actionIndex()
    {
        ...
        if ($_REQUEST['act'] == 'list') {
            ...
            if (!$this->smarty->is_cached('group_buy_list.dwt', $cache_id)) {
                ...
                $this->smarty->assign('feed_url', ($GLOBALS['_CFG']['rewrite'] == 1) ? "feed-typegroup_buy.xml" : 'feed.php?type=group_buy'); // RSS URL

                assign_dynamic('group_buy_list');
            }

            /* 显示模板 */
            $this->smarty->display('group_buy_list.dwt', $cache_id);
        }
...
//    }
            ...
            $this->smarty->display('group_buy_goods.dwt', $cache_id);
        }
