...
//-- 模版列表
        ...
        if ($_REQUEST['act'] == 'list') {
            ...
            $this->smarty->display('templates_list.htm');
        }
...
//-- 设置模板的内容
        ...
        if ($_REQUEST['act'] == 'setup') {
            ...
            $this->smarty->display('template_setup.htm');
        }
...
//-- 管理库项目
        ...
        if ($_REQUEST['act'] == 'library') {
            ...
            $this->smarty->display('template_library.htm');
        }
...
//-- 布局备份
        ...
        if ($_REQUEST['act'] == 'backup_setting') {
            ...
            $this->smarty->display('templates_backup.htm');
        }
