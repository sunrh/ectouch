...
//-- 用户帐号列表
        ...
        if ($_REQUEST['act'] == 'list') {
            ...
            $this->smarty->assign('action_link', array('text' => $GLOBALS['_LANG']['04_users_add'], 'href' => 'users.php?act=add'));
            ...
            $this->smarty->display('users_list.htm');
        }
...
//-- ajax返回用户列表
        ...
        if ($_REQUEST['act'] == 'query') {
            ...
            make_json_result($this->smarty->fetch('users_list.htm'), '', array('filter' => $user_list['filter'], 'page_count' => $user_list['page_count']));
        }
...
//-- 添加会员帐号
        ...
        if ($_REQUEST['act'] == 'add') {
            ...
            $this->smarty->assign('action_link', array('text' => $GLOBALS['_LANG']['03_users_list'], 'href' => 'users.php?act=list'));
...
//        $user['formated_frozen_money'] = price_format(0);
            ...
            $this->smarty->assign('action_link', array('text' => $GLOBALS['_LANG']['03_users_list'], 'href' => 'users.php?act=list&' . list_link_postfix()));
            $this->smarty->assign('user', $user);
...
//--  收货地址查看
        ...
        if ($_REQUEST['act'] == 'address_list') {
            ...
            $this->smarty->assign('action_link', array('text' => $GLOBALS['_LANG']['03_users_list'], 'href' => 'users.php?act=list&' . list_link_postfix()));
            $this->smarty->display('user_address_list.htm');
        }
...
//-- 查看用户推荐会员列表
        ...
        if ($_REQUEST['act'] == 'aff_list') {
            ...
            $this->smarty->assign('record_count', $user_list['record_count']);
            $this->smarty->assign('full_page', 1);
            $this->smarty->assign('action_link', array('text' => $GLOBALS['_LANG']['back_note'], 'href' => "users.php?act=edit&id=$auid"));


            $this->smarty->display('affiliate_list.htm');
        }
    }
