...
//-- 添加活动
        ...
        if ($_REQUEST['act'] == 'add') {
            ...
            $this->smarty->assign('action_link', array('text' => $GLOBALS['_LANG']['02_snatch_list'], 'href' => 'snatch.php?act=list'));
            $this->smarty->assign('cat_list', cat_list());
            $this->smarty->assign('brand_list', get_brand_list());
            $this->smarty->assign('form_action', 'insert');


            $this->smarty->display('snatch_info.htm');
        }
...
//-- 活动列表
        ...
        if ($_REQUEST['act'] == 'list') {
            ...
            $this->smarty->assign('action_link', array('text' => $GLOBALS['_LANG']['snatch_add'], 'href' => 'snatch.php?act=add'));
            ...
            $this->smarty->display('snatch_list.htm');
        }
...
//-- 查询、翻页、排序
        ...
        if ($_REQUEST['act'] == 'query') {
            ...
            make_json_result($this->smarty->fetch('snatch_list.htm'), '',
...
//-- 编辑活动
        ...
        if ($_REQUEST['act'] == 'edit') {
            ...
            $this->smarty->assign('action_link', array('text' => $GLOBALS['_LANG']['02_snatch_list'], 'href' => 'snatch.php?act=list&' . list_link_postfix()));
        ...
        if ($_REQUEST['act'] == 'update') {
            ...
            if (empty($_POST['goods_id'])) {
                ...
                $_POST['goods_name'] = $this->db->getOne("SELECT goods_name FROM " . $this->ecs->table('goods') . "WHERE goods_id= '$_POST[goods_id]'");
            }
            if (empty($_POST['start_price'])) {
                $_POST['start_price'] = 0;
            }
            ...
            $this->db->autoExecute($this->ecs->table('goods_activity'), $record, 'UPDATE', "act_id = '" . $_POST['id'] . "' AND act_type = " . GAT_SNATCH);
...
//-- 查看活动详情
        ...
        if ($_REQUEST['act'] == 'view') {
            ...
            $this->smarty->assign('action_link', array('text' => $GLOBALS['_LANG']['02_snatch_list'], 'href' => 'snatch.php?act=list'));
            $this->smarty->display('snatch_view.htm');
        }
...
//-- 排序、翻页活动详情
        ...
        if ($_REQUEST['act'] == 'query_bid') {
            ...
            make_json_result($this->smarty->fetch('snatch_view.htm'), '',
