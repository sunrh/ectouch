...
class FavourableController extends Controller
{
    public function actionIndex()
    {
        ...
        $exc = new Exchange($this->ecs->table('favourable_activity'), $this->db, 'act_id', 'act_name');
...
//-- 活动列表页
        ...
        if ($_REQUEST['act'] == 'list') {
            ...
            $this->smarty->assign('action_link', array('href' => 'favourable.php?act=add', 'text' => $GLOBALS['_LANG']['add_favourable']));
            ...
            $this->smarty->display('favourable_list.htm');
        }
...
//-- 分页、排序、查询
        ...
        if ($_REQUEST['act'] == 'query') {
            ...
            make_json_result($this->smarty->fetch('favourable_list.htm'), '',
...
//-- 修改排序
        ...
        if ($_REQUEST['act'] == 'edit_sort_order') {
            ...
            $sql = "UPDATE " . $this->ecs->table('favourable_activity') .
                " SET sort_order = '$val'" .
...
//-- 添加、编辑
        ...
        if ($_REQUEST['act'] == 'add' || $_REQUEST['act'] == 'edit') {
            ...
            $this->smarty->assign('action_link', array('href' => $href, 'text' => $GLOBALS['_LANG']['favourable_list']));

            $this->smarty->display('favourable_info.htm');
        }
