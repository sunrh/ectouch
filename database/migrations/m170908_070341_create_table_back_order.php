...
class m170908_070341_create_table_back_order extends Migration
{
    public function safeUp()
    {
        ...
        $this->createTable('{{%back_order}}', [
            'back_id' => $this->integer(8)->unsigned()->notNull()->append('AUTO_INCREMENT PRIMARY KEY'),
            ...
            'return_time' => $this->integer(10)->unsigned()->defaultValue('0'),
